...
**Omics BioAnalytics** is a Shiny app that performs common bioinformatics analyses such as descriptive analyses of demographics variables, exploratory data analysis, differential expression analysis and biomarker discovery analysis. The user can either use the provided sample data to run through the various analyses of the app or upload their own data (demographics variables, omics data).
...
## 3) Docker solution
- either have git installed or download the [repo](https://github.com/CompBio-Lab/omicsBioAnalytics) 
