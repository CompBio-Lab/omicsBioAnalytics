# tryCatch added to server part - not sure if works yet,
# app opens and uploads work as normal so far though
...
metadata_server <- function(input, output, session,
  ...
  error = function(e) { # <-- show error without crashing showNotification("Metadata Analysis failed — please check your data.", type = "error")
    NULL
    })
}
